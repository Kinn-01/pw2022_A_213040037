...
<?php
//  Koneksi ke DATABASE
// $conn = mysqli_connect('localhost', 'root', '', 'pw2022_a_213040037') or die('KONEKSI GAGAL!!');?
...
// query mahasiswa ketika tombol di klik
if( isset($_GET["cari"])) {
...
<html lang="en">
        ...
        <div class="col-6">
            <form action="" method="get">
              <div class="input-group mb-3">
                <input type="text" class="form-control" name="keyword" id="keyword" autocomplete="off" placeholder="Masukan Keyword">
  ...
  <?php $no = 1; foreach ($mahasiswa as $mhs) {?>
    <tr class="align-middle">
      <th scope="row"><?= $no++; ?></th>
      <td>
          <img src="image/<?php echo $mhs["gambar"]; ?>"
